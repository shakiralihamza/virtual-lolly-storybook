...
const Lolly: FC<LollyProps> = ({colorTop, colorBottom, colorMiddle}) => (

    <svg className="lollipop" style={{filter: 'drop-shadow(0px 0px 10px #000)'}} width="140px" height="400px" viewBox="0 0 163 431" version="1.1"
            ...
            <g id="Lolly">
                <g id="handle" transform="translate(65.000000, 137.000000)" fillRule="nonzero">
                    ...
                    <polygon id="Rectangle-Copy-3" fillOpacity="0.181584013" fill="#8C0040"
                             points="0 200 32 200 32 218 0 223.801515"></polygon>
                </g>
                <mask id="mask-2" fill="white">
                    <use xlinkHref="#path-1"></use>
                </mask>
                <use className="lollyBottom" fill={colorBottom} fillRule="nonzero" xlinkHref="#path-1"></use>
                <rect className="lollyTop" fill={colorTop} fillRule="nonzero" mask="url(#mask-2)" x="-25" y="-9"
                      width="224"
                      height="134"></rect>
                <rect className="lollyMiddle" fill={colorMiddle} fillRule="nonzero" mask="url(#mask-2)" x="-29" y="113"
                      width="224" height="111"></rect>
                <path
                    ...
                    id="shade" fill="#67000D" fillRule="nonzero" opacity="0.0961449033" mask="url(#mask-2)"></path>
                <mask id="mask-4" fill="white">
                    <use xlinkHref="#path-3"></use>
                </mask>
                <use id="shine" fill="#FFFFFF" fillRule="nonzero" opacity="0.113420759" xlinkHref="#path-3"></use>
                ...
                <path
                    ...
                    id="frozenhandle" fill="#A7563C" fillRule="nonzero" opacity="0.0615234375"></path>
            </g>
        </g>
    </svg>
